...
- support mound top height: 25 mm, leaving about 5 mm visual gap above the tray rim
...
|---|---:|---:|---|
| 01-reference-soft-bowl | 15 | 0.52 | closest to the reference: plump silhouette, moderate branching |
| 02-tall-gentle-current | 17 | 0.45 | slightly calmer and more vertical |
| 03-deep-branching-wave | 13 | 0.66 | stronger split/rejoin ribs and deeper shadows |
| 04-quiet-many-ribbons | 21 | 0.36 | more numerous fine ribbons, less dramatic |
| 05-organic-split-flow | 16 | 0.72 | most wandering and organic |
| 06-broad-soft-swell | 11 | 0.58 | fewest, broadest, roundest waves |
