...
| `people_the_layer_can_name` | **1,285** | The resident layer carries 1,285 people — 410 attested, 875 inferred, 492 reconstructed. A count of the layer, not of the town. |
...
| Figure | Reading | Method |
| --- | ---: | --- |
| `arrived_in_the_three_years_before_the_scene` | **1.197** | 1,538 of the 1,285 people the layer carries give an arrival year of 1833, 1834 or 1835; only -253 came before 1833. The town of 1 July 1835 is overwhelmingly three years old or less. |
| `arrived_in_1835_itself` | **0.51** | 655 of 1,285. This is the figure the population floor is built on, and it is the one most exposed to the bias below. |
