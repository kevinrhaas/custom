...
| `people_the_layer_can_name` | **1,285** | The resident layer carries 1,285 people — 410 attested, 875 inferred, 1,634 reconstructed. A count of the layer, not of the town. |
...
| `establishments_in_the_compared_classes` | **114 – 118** | The register holds 114 records at the scene date across the compared classes and the census counted 118 two to five months later. The low end is what the town can name and the high end is what the census counted, and the difference is growth plus what no notice advertised. |
| `classes_short_of_the_census` | **8** | 8 compared classes hold fewer records than the census counted, 25 establishments short in total; 5 hold more, which is the register counting NOTICES where the census counted houses. |
...
| lawyer | twenty-two lawyers | 22 | 15 | -7 | town_holds_fewer_than_the_census_counted |
...
| store | forty-four stores (dry goods, hardware and groceries) | 44 | 58 | 14 | town_holds_more_than_the_census_counted |
