...
| `Frederick W. Page` | Frederick W. Page | `page` | `page` | surname already minted | Elisha S. Page | 1 | directory fergus_chicago_directory_1843 |
...
| `Mills Joel C.` | Joel C. Mills | `c` | `mills` | the town already names a Mills | John A Mills (hh_mills_john_a); Samuel Mills (hh_mills_samuel) | 1 | research row T-0482 (no_corroboration), directory fergus_chicago_directory_1839, directory fergus_chicago_directory_1843 |
