...
* the pool the register offers this pass: **1891** candidates
* accepted under the pre-T-0638 reading: **698**
* accepted under the corrected reading: **706**
...
The tree holds **749** letter-list households. The pass, run today
against that same tree, derives **706**. `check.sh` runs this pass's
