...
* the pool the register offers this pass: **1833** candidates
* accepted under the pre-T-0638 reading: **673**
* accepted under the corrected reading: **676**
...
against that same tree, derives **676**. `check.sh` runs this pass's
