...
| `R4_surname_only_census` | 441 | A census reading that gives a surname this town already holds and no person of its own — the 1830 surname-only refusals and the 1840 heads. | May supply a FAMILY (spouse and child bands) to an existing head at `reconstructed`. Never a new head. |
...
| `R0_ineligible` | 13410 | Outside Chicago, the Bear Creek marriages (T-1129), the declared `researched_not_resident` names, post-scene arrivals with nothing to back-project from, and names this town already carries. | Never. |
...
| `R4_surname_only_census` | `census_1840` | 378 |
...
| `R0_ineligible` | `books` | 126 |
| `R0_ineligible` | `census_1830` | 136 |
| `R0_ineligible` | `census_1840` | 652 |
| `R0_ineligible` | `church` | 1605 |
...
| `R0_ineligible/earlier_than_the_window` | 159 |
| `R0_ineligible/later_only_and_not_backprojectable` | 9940 |
...
| `R4_surname_only_census/census_1840_head_surname_matches` | 349 |
...
### `R4_surname_only_census` — 441 rows
