...
|---|---:|
| rows | 14906 |
| ledger units considered (every non-`asserted` unit) | 23230 |
...
| `R0_ineligible` | 13108 | Outside Chicago, the Bear Creek marriages (T-1129), the declared `researched_not_resident` names, post-scene arrivals with nothing to back-project from, and names this town already carries. | Never. |
...
| class / rule | rows |
|---|---:|
| `R0_ineligible/already_carried_as_present` | 948 |
| `R0_ineligible/carried_by_the_cards_own_row` | 912 |
...
| `R0_ineligible/undated_reading` | 205 |
