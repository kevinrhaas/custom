...
| `R0_ineligible` | 13495 | Outside Chicago, the Bear Creek marriages (T-1129), the declared `researched_not_resident` names, post-scene arrivals with nothing to back-project from, and names this town already carries. | Never. |
...
| class / rule | rows |
|---|---:|
| `R0_ineligible/already_carried_as_present` | 1010 |
| `R0_ineligible/carried_by_the_cards_own_row` | 1087 |
| `R0_ineligible/earlier_than_the_window` | 157 |
| `R0_ineligible/later_only_and_not_backprojectable` | 9962 |
