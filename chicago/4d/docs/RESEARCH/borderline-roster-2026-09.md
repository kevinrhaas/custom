...
| `R2_in_window_single_source` | 182 | One appearance inside the window, no card, the ledger withheld it as a single source or on insufficient identity. | Mint a reconstructed resident under the read name. |
...
| `R0_ineligible` | 13564 | Outside Chicago, the Bear Creek marriages (T-1129), the declared `researched_not_resident` names, post-scene arrivals with nothing to back-project from, and names this town already carries. | Never. |
...
| `R2_in_window_single_source` | `church` | 143 |
...
| `R0_ineligible/earlier_than_the_window` | 129 |
| `R0_ineligible/later_only_and_not_backprojectable` | 9971 |
...
| `R0_ineligible/owned_by_the_attribute_band` | 193 |
| `R0_ineligible/researched_not_resident` | 9 |
| `R0_ineligible/surname_only_and_unmatched` | 260 |
| `R0_ineligible/undated_reading` | 291 |
| `R1_in_window_uncertain/card_presence_is_uncertain` | 814 |
| `R2_in_window_single_source/in_window_read_and_withheld` | 182 |
...
### `R2_in_window_single_source` — 182 rows

| name as read | dated | source | why it was withheld |
|---|---|---|---|
| Adelaide Bouchard | 1833-08-18 | `st_marys_bapt_1833_11_3_mother` | A dated appearance inside the window under a read name, withheld from the town for want of corroboration or identity, and carried on no card. |
| Adelaide Bouchard | 1833-08-18 | `st_marys_bapt_1833_12_3_mother` | A dated appearance inside the window under a read name, withheld from the town for want of corroboration or identity, and carried on no card. |
| Alexander | 1834-06-28 | `st_marys_bapt_1834_14_1_child` | A dated appearance inside the window under a read name, withheld from the town for want of corroboration or identity, and carried on no card. |
| Alexis Gagnier | 1833-10-04 | `st_marys_bapt_1833_15_2_father` | A dated appearance inside the window under a read name, withheld from the town for want of corroboration or identity, and carried on no card. |
| Andrew [Bouchard] | 1833-08-18 | `st_marys_bapt_1833_11_2_father` | A dated appearance inside the window under a read name, withheld from the town for want of corroboration or identity, and carried on no card. |
