...
1. **No unit-level ledger entry reaches the business or structure layers.** 179 asserted units land on residents and households and 0 on businesses and structures. Closing it means an authored business record (T-1180) and a seat on the ground (T-1198) for a claim to be asserted ONTO.
