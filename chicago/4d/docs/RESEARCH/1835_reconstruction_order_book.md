...
**2,267 people stand in the layer today** and **487** are still owed after the counters, so the town this book converges to is **2,754** — inside the model's 2,353-3,265. `--build` and `--check` both refuse a remainder that lands outside it.
...
2,267 standing plus 487 still owed is 2,754, inside the model's 2,353-3,265. Before the re-cut the same sum was 2,267 + 843 = 3,110, and the book was ordering a replacement for 826 people already in the layer. It is 218 above the model's 2,536 point, and that surplus is the 591 people drawn into 51 buckets past what the re-cut would now order — named in `recut_refusals`, held rather than clamped, and retired or re-familied by T-1196, T-1197 and T-1179 rather than by this book.
...
| `persons/female/10_19/north/lodging/none` | 11 | 5 | 6 | 5 | T-1175 |
...
| `persons/female/20_29/north/lodging/none` | 12 | 6 | 6 | 5 | T-1175 |
...
| `persons/female/40_49/south/lodging/none` | 5 | 2 | 3 | 1 | T-1175 |
...
| `persons/male/10_19/north/lodging/none` | 13 | 6 | 7 | 5 | T-1175 |
...
| `persons/male/20_29/north/lodging/none` | 20 | 10 | 10 | 8 | T-1175 |
