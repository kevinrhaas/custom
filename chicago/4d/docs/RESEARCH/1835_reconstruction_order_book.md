...
The roster offers 1,584 names the corpus printed and this project withheld. Each class is a licence, not a quota:

| class | offered | ticket |
|---|---:|---|
| `R1_in_window_uncertain` | 814 | T-1172 |
| `R2_in_window_single_source` | 134 | T-1172 |
...
| `persons/male/under_10/south/family/none` | 148 | 28 | 120 | 0 | T-1174 |
