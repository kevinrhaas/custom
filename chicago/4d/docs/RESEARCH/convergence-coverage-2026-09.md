...
Derived by `tools/report_convergence_coverage.py --build` (T-1144, acceptance 7) over `data/residents/households/`, the location reconciliation and the business register. Table: `data/research/convergence_coverage.json.gz`, 1,578 rows, one per person. Do not edit either by hand.
...
| --- | ---: | ---: | ---: |
| `roles[]` — trades, professions, offices | 138 | 189 | 1,251 |
| home (`lives_at`) | 56 | 120 | 1,402 |
| work (`works_at`) | 131 | 0 | 1,447 |
| other places — later addresses, business premises | 93 | 312 | 1,173 |

Of 1,578 people in 1,258 households.
...
**Places.** 2,310 location rows reach a person; 306 of them reach the scene date. By claim kind: `business_location` 119, `home` 1,578, `later_home_address` 119, `later_workplace_address` 363, `workplace` 131.
