...
**Places.** 2,998 location rows reach a person; 424 of them reach the scene date. By claim kind: `business_location` 112, `home` 2,269, `later_home_address` 119, `later_workplace_address` 367, `workplace` 131.
