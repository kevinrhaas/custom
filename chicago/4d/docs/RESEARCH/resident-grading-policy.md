...
## Spending the proposal onto the people the town already carries (T-0705)

`grading_proposal.json` is a proposal and, until T-0705, nothing in it had been written
...
**56 applied, 102 refused.** The town moved: attested **497 → 515**, inferred **907 → 889**,
