...
Unclassified: **0** (C1). Asserted units whose named field does not resolve on the record: **0** of 811 (C2). The resident synthesizer's declared drift from the cards it writes: **0** file(s) (C4).
