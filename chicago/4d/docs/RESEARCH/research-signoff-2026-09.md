...
Unclassified: **0** (C1). Asserted units whose named field does not resolve on the record: **0** of 489 (C2). The resident synthesizer's declared drift from the cards it writes: **0** file(s) (C4).
...
**21,465** reading units were deliberately kept out of the town, and **0** of them do so without a stated reason (C8). A refusal that cannot say why is indistinguishable from an oversight, which is the whole point of keeping them.
