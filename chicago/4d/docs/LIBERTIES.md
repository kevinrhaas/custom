...
**Revised:** 2026-08-27 — **the artefact is retired and the number that described it was wrong.**
T-0184 mitred the ribbon's joints, so the wedge this entry admitted no longer exists anywhere on the
street layer: `tools/measure_road_joints.mjs`, a 2 cm plan lattice over every authored bend, reads
**0.000 m2 uncovered** where it read 23.472 m2 before. Everything above about the two lines, the
13.8 m chord and the swing onto the fill stands unchanged; only the admission in paragraph (1) is
discharged. And the figure in it is corrected rather than quietly dropped: measured at the joint
itself, Dearborn's corner left **0.00 m2 uncovered, not 0.30**. South Water Street's 10.5 m roadway
covers the WHOLE of that 0.61 m2 sector and not half of it — the sector reaches at most 3.50 m from
[698.93, 7] and South Water's ribbon spans N 1.8 to N 12.3 there — so the one joint this entry chose
to admit to was the one joint in the town that never showed. The wedges it named in the same breath,
on South Water Street's own bends, were real and were 4.29, 4.25, 3.58, 1.77 and 1.77 m2. The
mitre's own cost is recorded separately as **L182**.
**Recorded:** 2026-08-24.

### L182 — A mitred ribbon corner stands up to 29 mm outside the street's own recorded half-width
