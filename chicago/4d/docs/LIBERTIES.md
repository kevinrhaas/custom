...
### L231 — New York Clothing Store: the address is the paper's, the building is entirely ours
...
the fabric and is recorded at **L232**.
Related: **L5** and **L8** (footprints invented outright) · **L9** (the Green Tree footprint this
...
**Recorded:** 2026-09-11 (T-0385).

### L232 — Three doors north: the count is printed, the door and the side of the street are not
...
same one `bates_auction_room` stands on immediately north of this shop, across the
mouth of the alley. The count of doors is
