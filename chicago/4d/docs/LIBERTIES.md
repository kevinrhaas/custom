...
### L211 — 100 documented businesses stand on 1 July 1835 because nothing says they closed
...
**Scope:** `register_1835.businesses[survival_liberty_required]` — 100 businesses, enumerated
...
**Consequence:** as the register is seeded into the town, more than half of these reach
something a visitor can see. Measured on the register as it stands on 2026-09-12, **55** of
the 100 do — 16 enrich a house already standing, 17 ask for a new building, 22 take a street
face — and **45** reach nothing yet. That split moves whenever an anchor is re-read or two
firms are judged one house, and it is a dated reading rather than a standing claim; the 100
is the number this entry is held to and the number the gate re-derives. It has now moved four
...
to 101; and T-0408 joined the two printings of the Lake Street houses-and-lots notice the
register had been holding as 'G. Blanshard' and 'F. G. Blanshard' — one cut signature and one
set whole, over the same advertisement — taking 101 to 100. No movement is a business leaving
Chicago; all are shops the register was holding twice. Every one
