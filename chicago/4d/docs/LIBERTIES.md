...
**Heacock's house stood on nothing, and now does not.** `heacock_house_monroe` is documented —
built in the spring of 1835, moved a block on rollers — and Monroe Street lay about 215 m south
of the modelled terrain box, so the phase declared `ground_contact: outside_modelled_ground`.
That was the L40 state again, for one building, and the entry said it would resolve when a
terrain epoch reached south of Madison. T-0464 reached Twenty-Second Street on 2026-09-13; the
outline now sits within 0.35 m of the ground under it, the declaration is dropped and this
paragraph is the only thing left of it. The rest of L84 stands: what street the house was on
that July, and where along it, are still invented.
