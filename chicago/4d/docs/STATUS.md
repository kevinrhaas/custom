...
in the first place**. Corrected in place in `bake_ao()` and R-W3a; **T-0208** filed to answer the
question properly, from a rendered frame, before R-W3a builds a cage to improve a figure nobody
has measured correctly. T-0208 also carries the unwrap: an atlas two-thirds empty is two-thirds
...
answerable for the first time, and it is T-0208. Turning the flag on in the same run that made it
