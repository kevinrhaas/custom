...
from it — none of which the record said before. **L177** records the head as the invention it is;
...
its rhythm is nearly three times coarser than the model's — is **T-0184**.
