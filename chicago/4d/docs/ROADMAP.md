...
2. **"Mean 0.265, 69 % of texels below half" is wrong twice over, and so is the 0.38.** First,
   ...
   black). **T-0208 answers it from a rendered frame before this parcel builds a cage to improve
