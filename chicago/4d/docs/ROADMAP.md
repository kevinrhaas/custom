...
| **6** | RENDERING | **K49(a)** | UNSEEN | **CLAIMED 2026-08-16 — the sward is the weighted draw K49 named, and the census convicted the units before it got to the tail.** Measurement half of a measure-then-fix split; **K49(b)** below is the fix and is SEEN. See K49's box |
