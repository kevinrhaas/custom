---
id: T-0310
title: Reading the Democrat, January 1834: Vol. I Nos. 7-10
state: done
epic: PAPERS
requested_by: owner
seen: false
...
closed: 2026-08-28
pr: 482
claimed_by: run 8/28/2026, 1:38:09 PM CT
blocked_on: null
needs_bake: false
---

An extraction pass over the *Chicago Democrat* of January 1834 — Vol. I Nos. 7-10, 4 issues —
through the T-0257 schema, writing one `data/research/newspapers/extracted/<issue_id>.json`
per issue. Piece 3 of 8 of **T-0258 — Reading the Democrat, part one: November 1833 to
...
- `chicago_democrat_1834_01_07` — 1834-01-07
- `chicago_democrat_1834_01_14` — 1834-01-14
- `chicago_democrat_1834_01_21` — 1834-01-21
- `chicago_democrat_1834_01_28` — 1834-01-28

**Transcription dialect:** prose. 488,263 characters, 6,006 lines.

THE FIRST LETTER LIST IN THE RANGE IS IN THIS PIECE: 1834-01-28. Ruling 1 applies in full — every listed name mints a resident candidate, `letter_list_only` true, and the extracted count is checked against a hand count of the printed list and stated in the PR.
...
- Every issue listed above has an extraction file, and `coverage.json` declares
  1834-01-01 to 1834-01-31 so the gate asserts the range rather than counting files.
