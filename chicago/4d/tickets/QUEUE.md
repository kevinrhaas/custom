...
T-1316 — check.sh no longer fits a steward run's 600 s foreground ceiling: 9 m 52 s measured on 2026-09-18, so the gate has to be run in two halves by hand
