...
T-1375 — The community attribute across the resident layer: the closed vocabulary, a tiered community on every person and household derived from the evidence the layer already holds, the People view's community filter, and the shares table printed against the town model
