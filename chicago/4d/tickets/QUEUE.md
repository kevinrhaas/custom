...
T-1401 — The anchored houses resolved onto their landmark, and the register's double-printed partners folded: every anchored location carries the id of the structure or firm it stands against, and a partner the register styles two ways is one partner on the firm's own card
