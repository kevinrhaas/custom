...
T-1498 — converge_resident_layer.py --run moves 189 lines of the order book on a clean tree, so the whole-layer fixed point cannot be listed in the derived manifest's second pass
