...
# BLOCKED-OWNER T-0135 (opened 2026-08-21, META) — The draw-call ceiling is checked at one camera, and it is not the worst one
#     asks: The gate now reads the worst of five named stands and it is RED: 1,320,377 tris of 1,000,000 at full, 1,144,787 of 900,000 at balanced, 992,617 of 60…
# BLOCKED-OWNER T-0141 (opened 2026-08-22, META) — A mast reads over the Green Tree's own roofline, which its committed placement forbids
#     asks: The Green Tree's committed placement puts it a full block back from the west bank, so no mast can subtend its roofline from the visitor's own stand.…
# BLOCKED-OWNER T-0251 (opened 2026-08-27, META) — first_presbyterian_church cannot come onto the Lake Street plat without displacing physicians_office
#     asks: Does a documented building displace an inferred-household unit when the plat repair puts them on the same lot? first_presbyterian_church needs 3.395…
...
# BLOCKED-OWNER T-0419 (opened 2026-08-29, META) — The re-centred South Water corridor stands 8.58 m off its own block faces, and the strip between belongs to neither
#     asks: Is the platted BLOCK grid on the South Water reach offset from the control too — branch A, which re-cuts 32 lots carrying 53 committed roofs and drop…
...
# BLOCKED-OWNER T-0991 (opened 2026-09-10, META) — Eight cards assert an 1835 trade out of a PRE-scene printing, and T-0693's later_occupation pointer cannot hold one:…
#     asks: Six cards carry an 1835 trade printed only in the Chicago Democrat of 26 November 1833. (a) blank the 1835 field and mint an earlier_occupation point…
# BLOCKED-OWNER T-1087 (opened 2026-09-12, META) — place_vocabulary's B4 names Wabansia and Kinzie's Addition as surveys this project commits none of, and it commits bo…
#     asks: resolution and basis for Wabansia and Kinzie's Addition: both surveys are committed now, so B4's stated reason has expired — outside, inside, or B4 w…
# BLOCKED-OWNER T-1476 (opened 2026-09-20, META) — A household record and a household in the town model are not the same unit: the layer holds 1,391 records where the m…
#     asks: Is a one-person letter-list record a household in the model's sense, or a person still awaiting one? The layer holds 1,391 records against a model of…
...
#     asks: Blocks 28 and 45 are cut EIGHT lots four-to-a-face; the plat sheet counts TEN in the West Division's two-by-five arrangement, and the re-cut is refus…
#
