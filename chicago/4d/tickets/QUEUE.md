...
T-1450 — Adopt the PBR texture library the owner supplied: it is dimensionally interlocked with the material sheet and its relief maps carry the modules they declare, so wire normal/roughness/AO per substrate now and vendor the whole set for the Unreal target
