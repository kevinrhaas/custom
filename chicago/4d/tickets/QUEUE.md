...
# ---
# --- WHAT HAPPENED IN THE HOUR AFTER, and it is the finding rather than a footnote.
# --- This band was written assuming runs would have to land those PRs in laps. They did
# --- not need to. T-0815 closed five PRs dev had outrun (#799 superseded by #816; #432,
# --- #562, #599, #601 between 515 and 672 commits behind, carrying bakes) — and then the
# --- LANE DRAINED ITSELF, merging #892, #836, #839, #876, #899, #868, #898 and #801 with
# --- no help at all, the moment #836 took the published tree off the 32 MB wall and dev's
# --- gate went green. 21 open at 16:00Z, 9 by 17:25Z.
# ---
...
# ---
# --- AND THE ID COLLISIONS ARE NOT A SIDE NOTE EITHER. Landing this one ticket band cost
# --- FOUR restamps against a moving dev — T-0803, T-0804, T-0805, then T-0812 — because
# --- parallel slices draw ids from one counter and a claim only becomes visible when its
# --- PR merges. That is T-0813's second half.
# ---
