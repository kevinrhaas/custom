...
T-1445 — Adjudicate the 285 anonymous roofs against the re-derived programme and the placement policy: one verdict per roof — keep, refamily to a named family, or retire — each with the order-book bucket it serves and the reason it is a substitution, published as a re-derivable redeal ledger and gated; no roof moves ground
