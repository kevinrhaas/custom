...
T-1348 — The officers' quarters are occupied by name: every U.S. Army officer this layer places at Chicago in the scene window adjudicated against the post, the ones the evidence can seat put in the quarters the dossier assigns, the ones it cannot said so and left — so the building that reads 'subordinate officers of the garrison' names them
