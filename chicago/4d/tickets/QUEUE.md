...
T-1392 — Every age in the town answers to the person's own evidence: a roll, a trade or a press appearance is read before the kinship word a household happens to use, and an obituary's birth interval the card refutes is refused rather than spent
