...
T-1494 — Migrate the phase-one South parcel's 11 refamilied roofs whose id moves: the recipe refamilied, generate_inferred_infill taught the two boarding-house families the redeal sends it, the records re-derived, every file naming an old id moved with it, rebaked and published
