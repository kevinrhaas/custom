---
id: T-0929
title: Land or close the stale readings: the open PRs whose base is far enough behind that they need a real read against dev before either
state: split
epic: PIPELINE
requested_by: owner
seen: false
...
blocked_on: null
needs_bake: false
closed_at: 2026-09-07T02:44:16.949Z
claimed_run: null
---
...
`#841` (base is ancient), `#953`, `#955`, `#991`, `#992`, `#998`, `#1009`.
