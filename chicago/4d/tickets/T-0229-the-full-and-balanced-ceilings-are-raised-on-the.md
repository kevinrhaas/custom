---
id: T-0229
title: The full and balanced ceilings are raised on the owner's decision, and the raise expires with T-0209's timber cull
state: open
epic: RENDERING
requested_by: owner
seen: false
...
The `full` and `balanced` scene-detail ceilings are raised on the owner's decision, and the raise expires with T-0209's timber cull.
...
T-0209's `tools/measure_stand_budget.mjs`, at the release smoke's own worst
...
argument for T-0209, and it is written into `main.js` beside the constants so
the sixth is harder to reach for.

**Acceptance:** (state it before working — the definition of done, never weakened to pass)

- T-0209's first step (cull the timber from the sun's camera) has landed.
