...
Both this and **T-0425** fell out of **T-0385**, which taught `tools/compile_register.py`
...
- Whichever way it goes, `docs/LIBERTIES.md` L215's three-part admission — the side of
