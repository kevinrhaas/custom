...
closed: 2026-08-28
pr: 0
claimed_by: run 8/28/2026, 2:10:56 PM CT
blocked_on: null
needs_bake: false
---

An extraction pass over the *Chicago Democrat* of February 1834 — Vol. I Nos. 11-14, 4 issues —
through the T-0257 schema, writing one `data/research/newspapers/extracted/<issue_id>.json`
per issue. Piece 4 of 8 of **T-0258 — Reading the Democrat, part one: November 1833 to
...
- `chicago_democrat_1834_02_04` — 1834-02-04
- `chicago_democrat_1834_02_11` — 1834-02-11
- `chicago_democrat_1834_02_18` — 1834-02-18
- `chicago_democrat_1834_02_25` — 1834-02-25

**Transcription dialect:** ruled. 465,667 characters, 15,040 lines.

The ruled dialect starts here and runs to the end of the parent's range. 1834-02-04 carries a letter list.
...
- Every issue listed above has an extraction file, and `coverage.json` declares
  1834-02-01 to 1834-02-28 so the gate asserts the range rather than counting files.
