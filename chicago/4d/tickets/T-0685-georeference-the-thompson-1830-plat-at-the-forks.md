...
blocked_on: Which is the planform of record at Wolf Point? Thompson 1830 puts the North Branch 27-43 m (east bank) and 35-60 m (west bank) west of the committed Wright 1834 line and 20 m wider; the main stem agrees inside the declared +/-20 m. Moving the bank re-derives every waterline in the project, so nothing was moved. The measurement and what each answer costs are in the ticket and in docs/RESEARCH/thompson_forks_georeference.md.
needs_bake: false
closed_at: null
