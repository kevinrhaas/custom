...
blocked_on: null
needs_bake: false
closed_at: 2026-09-05T13:28:01.385Z
...
Piece 2 of 4 of **T-0613 — Volume 4 of the Newberry index has a much worse text layer than volumes 1-3, and a tesseract re-OCR reads the cards it loses**, split because the parent needed more than one run's demonstration to be done. The parent keeps the full ask and its links; this ticket owns one slice of it.

**Acceptance:** (state it before working — one demonstration, never weakened to pass)
- `--extract --ocr --volume 4 --pdf <path> --pages A-B` over pages 1 to 306, in as many foreground
