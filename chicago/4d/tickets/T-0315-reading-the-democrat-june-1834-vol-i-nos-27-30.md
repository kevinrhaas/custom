---
id: T-0315
title: Reading the Democrat, June 1834: Vol. I Nos. 27-30
state: claimed
epic: PAPERS
requested_by: owner
seen: false
...
closed: null
pr: null
claimed_by: run 8/28/2026, 7:51:44 PM CT
blocked_on: null
needs_bake: false
---

An extraction pass over the *Chicago Democrat* of June 1834 — Vol. I Nos. 27-30, 4 issues —
through the T-0257 schema, writing one `data/research/newspapers/extracted/<issue_id>.json`
per issue. Piece 8 of 8 of **T-0258 — Reading the Democrat, part one: November 1833 to
...
- `chicago_democrat_1834_06_04` — 1834-06-04
- `chicago_democrat_1834_06_11` — 1834-06-11
- `chicago_democrat_1834_06_18` — 1834-06-18
- `chicago_democrat_1834_06_25` — 1834-06-25

**Transcription dialect:** ruled. 454,800 characters, 16,859 lines.

THIS PIECE MEETS T-0289 AT ITS EDGE. July 1834 is already read (`extracted/chicago_democrat_1834_07_0*.json`), and Goss & Cobb advertise there from 'their old stand, corner of Lake and Canal streets' — so a June 1834 reading has a documented successor a week later for anything it finds, which is the cheapest corroboration in the epic. Read the July files before this one.
...
- Every issue listed above has an extraction file, and `coverage.json` declares
  1834-06-01 to 1834-06-30 so the gate asserts the range rather than counting files.
