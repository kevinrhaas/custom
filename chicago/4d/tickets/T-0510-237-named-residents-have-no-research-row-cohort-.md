...
cohorts of 79; this ticket is **cohort 15** (`data/research/residents/pass_15_79_cohort.json`).
...
2. `data/research/residents/pass_15_findings.json` completed (`pending_person_ids: []`), a source record
   per source cited, and the durable package `chicago/reference/resident-research/T-0510/`
