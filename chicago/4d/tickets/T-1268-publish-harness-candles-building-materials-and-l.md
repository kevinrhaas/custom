...
Author only this bounded content batch: `mend-the-harness`, `soap-and-candles`, `materials-for-a-roof`, `boots-and-leather`. Each is a separate short jaunt, not stops in one long tour. The full briefs define their distinct premises.
...
**Touch points:** data/jaunts/mend-the-harness.json, data/jaunts/soap-and-candles.json, data/jaunts/materials-for-a-roof.json, data/jaunts/boots-and-leather.json; associated content evidence/locators and generated outputs.
