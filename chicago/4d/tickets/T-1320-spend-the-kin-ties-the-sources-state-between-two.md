...
Spend the kin ties the sources state between two people this town already holds: the wives, sons and daughters named for a held head where the relative is ALSO a held resident, written onto both cards as a tie and never as a new person.
