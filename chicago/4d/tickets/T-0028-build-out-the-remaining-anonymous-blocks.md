...
generator's `REFUSED_FAMILIES`, and the fault is filed against the deal as **T-0275**. Recorded as
liberty **L201**.

**Successor filed: T-0277**, per this ticket's own programme rule. It names what is left: no
...
**Closed on this block.** The programme continues in T-0277, which is the shape this ticket's own
