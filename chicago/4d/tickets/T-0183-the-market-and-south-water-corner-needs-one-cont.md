...
blocked_on: Which corner rule closes South Water Street's west end: the centreline on the committed bank (built and gated on this branch — blk_south_water_market emits 8 lots, 4,957 m2, 15.1 m of depth at Market's corridor edge, with the corridor's north half overhanging the water the way this street already does east of Franklin), or the north corridor EDGE on the bank (PR #573's reading, which measures 2.8 m of depth and calls the block a wedge that pinches out)? The two runs answered the owner's 2026-08-29 ruling differently and both are on the record; PR #577 holds the first.
needs_bake: false
---
