# BOARD — generated by `tools/ticket.mjs board`, Aug 28, 2026, 8:26 AM CT. Do not edit.

## In the queue, in the owner’s order (63)
...
- **T-0257** An extraction schema, and the gazetteer the papers compile into · **OWNER**
...
- **T-0288** ticket.mjs claim identifies your own branch by NAME, so it never warns about the rival branch that matters most
...
- **T-0276** The 'Verified' 1833 transcription reads NOV. 19, and the Democrat published no such issue
  - **the question:** Does the top of the first supplied 1833 scan page read NOV. 19 or NOV. 26? The scans are yours; the answer decides whether the deposit holds an issue this project does not know about, or the transcription misread its own masthead.
...
- **T-0282** The ceiling declaration cannot see the shrub stratum, and no card a visitor opens carries it · 2026-08-28 · PR #455
