# BOARD — generated by `tools/ticket.mjs board`, Aug 29, 2026, 6:24 PM CT. Do not edit.
...
- **T-0358** The Thompson plat's block NUMBERING is uncommitted, so the corpus's only lot-and-block address cannot be placed · claimed
