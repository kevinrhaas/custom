# BOARD — generated by `tools/ticket.mjs board`, Aug 29, 2026, 8:55 PM CT. Do not edit.

## In the queue, in the owner’s order (78)
...
- **T-0428** derive_timber_belt.py --write leaves trees.js unparseable when the derived belt has more points than the committed one
...
- **T-0416** Wm. Sabine, John Dave and the Dearborn wine store: the three storefronts the street-face policy refuses for want of a fronting roof
  - **the question:** Is a corner side a face, and is the centreline band? Measured: a corner-side ruling seats +12 shops (Dearborn 8, La Salle 3, Canal 1) and NONE of this ticket's three; adding the band seats one more, Wm. Sabine. The three storefronts here want frontage on North Water and Dearborn, not a widened reading.
...
## Split into pieces (the pieces are in the queue) (29)
...
- **T-0336** The 31 July 1835 letter list, standing in all four August Democrats · **OWNER** · 2026-08-29 · PR #532
- **T-0337** One man is two proprietors of Russell & Clift, and the gazetteer has no rule that can join them · 2026-08-29 · PR #543
- **T-0345** Mason's blacksmith shop is anchored on Graves' Tavern until 16 July 1834 and on the Tremont House from 10 September, and the register holds both as standing placements · 2026-08-29 · PR #553
- **T-0350** D. Weaver's advertisement is dated Nov. 12 in two printings and Nov. 19 in the one the ledger believed · 2026-08-29 · PR #541
