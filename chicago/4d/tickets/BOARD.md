# BOARD — generated by `tools/ticket.mjs board`, Aug 29, 2026, 1:15 AM CT. Do not edit.

## In the queue, in the owner’s order (72)

- **T-0297** Reading the Democrat, August 1835: the four issues after the scene date · **OWNER**
...
- **T-0350** John Holbrook's store takes its door on South Water, one door from Dearborn
  - **the question:** May a platted business-front lot carry TWO documented storefronts standing at the street, as it already carries one documented store plus the anonymous run? The Chicago American of 13 June 1835 puts John Holbrook's clothing store 'South Water street, one door from Dearborn', which is the next front east of the American's own office — and both seat on lot 0 of blk_south_water_dearborn. Your 2026-08-27 clause excuses ONE researched store at the street on a business-front lot; tools/plat_occupancy.py's fourth condition (len(holders) != 1) then refuses a second, so the store cannot stand. Nothing overlaps: Holbrook clears the American office by 3.05 m and the lot line by 1.53 m, and the block's own frontage run does not physically stand on lot 0 at all (all three of its roofs are on lot 4 — T-0355). The building, its bake, its signboard and its liberty are built and every other gate is green; only this clause is red. Extend the clause to any number of researched storefronts standing at the street on a business-front lot, or hold the line at one?
...
## Split into pieces (the pieces are in the queue) (22)
...
- **T-0306** The American names six Chicago storefronts with usable placements and none of them is standing in the model yet — T-0350, T-0351, T-0352, T-0353, T-0354
...
- **T-0096** Did the second Fort Dearborn carry a flagstaff, and can anything but a retrospective plate say so · 2026-08-28 · PR #447
...
- **T-0155** The changelog stamper has the same after-publish trap the ticket tool just lost · 2026-08-28 · PR #496
- **T-0156** The interior/silhouette discriminator counts edges internal to a layer as interior · 2026-08-28 · PR #471
...
- **T-0210** The desktop smoke's stage 9 times out clicking the panel close, on an unmodified tree · 2026-08-28 · PR #470
