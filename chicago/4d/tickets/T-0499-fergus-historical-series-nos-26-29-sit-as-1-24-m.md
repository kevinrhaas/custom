...
**The ask — the FIRST half of the volume by page index.**
...
2. Read the pages of the FIRST half of the volume by page index and author `data/research/books/extracted/fergus_26_29_first_half.json` —
