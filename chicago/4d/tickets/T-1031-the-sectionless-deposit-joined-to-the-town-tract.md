---
id: T-1031
title: The sectionless deposit joined to the town: tract() resolves or refuses a lot-and-block-in-a-named-town, entries and crosswalk append, and completeness_probe re-derives
state: open
epic: META
requested_by: loop
seen: false
...
The sectionless deposit joined to the town: tract() resolves or refuses a lot-and-block-in-a-named-town, entries and crosswalk append, and completeness_probe re-derives.
