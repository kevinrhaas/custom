---
id: T-0432
title: Open blk_south_water_dearborn: 4 roofs of headroom on 2 free lots
state: open
epic: META
requested_by: loop
seen: false
...
Open `blk_south_water_dearborn`: 4 roofs of headroom on 2 free lots.

Piece 4 of 4 of **T-0420 — Open the four South Water blocks T-0009 has
...
- `blk_south_water_dearborn` deals its 4 roofs against its own committed lots — no lot outside the
