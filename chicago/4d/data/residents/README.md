...
(known only from the post office's letter lists). Until T-0592 each pass
...
**As of T-0592, no new household is minted with a legacy prefix.** A
...
The **747 households already minted under a legacy prefix before T-0592** were
