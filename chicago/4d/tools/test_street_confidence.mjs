...
ok(streets.length - trodden.length === 27,
  `and the platted-but-unopened lines ship with no track at all — the School Section's`
  + ` tiers, Kinzie's Addition's eleven since T-1060, and the Michigan St tract's two`
  + ` streets and two alleys since T-1075 — ${streets.length - trodden.length}`);
