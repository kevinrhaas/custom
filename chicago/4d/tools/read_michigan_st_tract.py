...
def _identity(out, doc):
    ...
    return {
        ...
        "north_south_street_is_market_street": {
            ...
            "reading": "The tract's north-south street stands 16.7 m east of the easting "
                       "`market_north` already holds in data/streets/1835.json, on the far "
                       "side of Kinzie Street from it. That is inside the 16.19 m RMS this "
                       "sheet's own fit carries and well inside a street's width, and there "
                       "is no other north-south street within a hundred metres for it to be. "
