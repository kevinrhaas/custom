...
# build.py would re-stale; the terrain and pier_crib reaches stay at 2 each.
#
# 383 -> 384 and 381 -> 382 on 2026-09-11 (T-1037): the New York Clothing Store, Tuthill
# King's clothing house, raised at the third door north of the Tremont House once T-0385
# had read the landmark off the one impression of his card that sets it. One new
# `frame_storefront` record, so one more committed asset and one more mesh a change to the
# shared generator modules or to build.py would re-stale; the terrain and pier_crib
# reaches stay at 2 each.
#
STATED = {
    "assets": 384,
