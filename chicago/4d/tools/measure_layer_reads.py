...
RESIDENTS_HOUSEHOLD_READS: dict[str, tuple[str, str]] = {
    ...
    "persons[].resident_research.summary": ("shown", "escapeHtml(String(rr.summary ?? ''))"),
    ...
    "persons[].resident_research.evidence_for": ("shown", "rr.evidence_for ? `<br><span class=\"res-why\"><b>For:</b>"),
    "persons[].resident_research.evidence_against": ("shown", "rr.evidence_against ? `<br><span class=\"res-why\"><b>Against:</b>"),
    "persons[].resident_research.proposed_facts": ("shown", "escapeHtml(rr.proposed_facts)"),
    "persons[].resident_research.notes": ("shown", "escapeHtml(rr.notes)"),
    "persons[].resident_research.source_ids": ("shown", "(rr.source_ids || []).map((id) => citationsById.get(id))"),
    "persons[].resident_research.candidate_ids": ("shown", "escapeHtml((rr.candidate_ids || []).join(', '))"),
    ...
    "persons[].resident_research.candidates[].basis": ("shown", "escapeHtml(String(c.basis ?? ''))"),
    "persons[].resident_research.candidates[].conflicts": ("shown", "escapeHtml((c.conflicts || []).join(' '))"),
    ...
    "persons[].resident_research.refusals[].reason": ("shown", "escapeHtml(String(r.reason ?? ''))"),
    ...
    "persons[].name_ruling.takes": ("shown", "The card takes ${escapeHtml(String(ruling.takes ?? ''))}"),
    "persons[].name_ruling.over": ("shown", "over ${escapeHtml(String(ruling.over ?? ''))}"),
    "persons[].name_ruling.displayed_name_was": ("shown", "escapeHtml(String(ruling.displayed_name_was ?? ''))"),
    "persons[].name_ruling.reasoning": ("shown", "escapeHtml(String(ruling.reasoning ?? ''))"),
    "persons[].name_ruling.the_id_did_not_move": ("shown", "escapeHtml(String(ruling.the_id_did_not_move ?? ''))"),
    ...
    "persons[].merge_ruling[].for_merge": ("shown", "<b>For a merge:</b> ${escapeHtml(String(r.for_merge ?? ''))}"),
    "persons[].merge_ruling[].against_merge": ("shown", "<b>Against:</b> ${escapeHtml(String(r.against_merge ?? ''))}"),
    ...
    "old_settler_deaths.people[].matched_by": ("shown", "escapeHtml(String(entry.matched_by ?? ''))"),
    ...
    "old_settler_deaths.people[].birth_year_arithmetic": ("shown", "escapeHtml(String(entry.birth_year_arithmetic ?? ''))"),
