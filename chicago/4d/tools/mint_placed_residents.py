...
residents is exactly the invention this project exists not to make.
  ...
  outside it), not a location. Before T-0598 that test's name doubled as this
...
# T-0598: the pass-name/legacy-prefix pairs `town_family_names` skips for THIS
...
# household minted plain, after T-0598, by either pass is still recognized.
...
def self_test() -> int:
    ...
    want("T-0598's pairs name the same three passes",
    ...
    # household minted before T-0598 still carries, or the field a fresh mint
