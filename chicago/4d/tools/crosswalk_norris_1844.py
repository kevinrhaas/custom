...
def main():
    ...
    for r in people:
        ...
        # a trade printed against their name in 1844 (T-0569). The predicate is
        # tiebreak's, ONE copy for all three directory crosswalks: this file
        # carried its own and Fergus 1843 carried none at all, which is how the
        # same bug was live in 1843 a month after it was fixed here (T-0867).
        if not tiebreak.is_trade(r["occupation"]) and any(x["occupation_1844"] for x in rows):
