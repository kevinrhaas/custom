...
RULES = {
    ...
    "a_dated_appearance_bounds_a_presence": {
        ...
        # this pointer does not go red today -- it would go red the day T-1327 closed, on
        ...
        # and asserted it; the register sponsorships and the press notices are T-1327's.
        "ticket": "T-1327",
        "statement": (
            ...
            "and T-1327 now. This ruling hands the date on and writes nothing: it "
