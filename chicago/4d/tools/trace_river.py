...
Needs numpy, scipy, Pillow. Not part of tools/check.sh — like the datum
re-derivation it is a deliberate, occasional re-run, and it degrades to a clear
skip when the dependencies or the network are missing.
"""
...
def main() -> int:
    ...
    for r in runs:
        ...
        if cen_n > 0 and cen_e > -40:
            key = ("north_division_shore",
                   "North Division shore: east bank of the North Branch and north bank of "
                   "the main stem")
        elif cen_e > 0:
            key = ("south_division_shore",
                   "South Division shore: south bank of the main stem and east bank of the "
                   "South Branch")
        else:
            key = ("west_division_shore",
                   "West Division shore at Wolf Point: west bank of the North Branch and "
                   "west bank of the South Branch")
        named.append((key[0], key[1], r))
    ...
    river_fc = {
        ...
        "name": "e1834_harbor_cut river",
        "crs": {"type": "name", "properties": {"name": "urn:ogc:def:crs:EPSG::26916"}},
        "_doc": "Water polygon and bank lines for the Chicago River forks, terrain epoch "
    ...
    hydro_fc = {
        "type": "FeatureCollection",
        "name": "e1834_harbor_cut hydrology",
        "crs": {"type": "name", "properties": {"name": "urn:ogc:def:crs:EPSG::26916"}},
        "_doc": "Secondary water at the forks. Generated by tools/trace_river.py — do not "
