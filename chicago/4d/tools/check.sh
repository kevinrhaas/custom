Warning: truncated output (original token count: 60607)
...
# walks instance matrices on a lattice centred on…10607 tokens truncated… at all; where it can also read a
