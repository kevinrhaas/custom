...
is **L221**. The mechanism is deliberately the business pass's, imported rather than
...
def note_for(row: dict) -> str:
    ...
    if row["outcome"] == "placed":
        return (
            ...
            f"The rule is docs/RESIDENCE-BACK-PROJECTION.md and the liberty is L221; a "
...
def build(records=None):
    ...
    ledger = {
        ...
        "_doc": "GENERATED by tools/back_project_residences.py (T-0669). Every address a "
                ...
                "of docs/RESIDENCE-BACK-PROJECTION.md. The policy is L221 and the unit of "
