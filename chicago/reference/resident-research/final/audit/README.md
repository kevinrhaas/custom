...
| voter / civic evidence | **294** | 21.7% | a poll book, tax list, muster roll, treaty payment or other public record |
...
| rests on one source | 872 | one source id on the card and no second category to check it against |
