...
| file | what it is |
| --- | --- |
| `resident_audit_master.csv` | the table, one row per person, 1308 rows and 45 columns |
...
Each line is *how many of the 1308 people carry at least one record of that kind*.

| coverage | of 1308 | % | what counts |
| --- | ---: | ---: | --- |
| identities | **1305** | 99.8% | a name with at least one source id anywhere on the card |
...
of the 1308 people. Before T-0733 nothing ruled on any of them, and a conflict
...
| rests on one source | 836 | one source id on the card and no second category to check it against |
