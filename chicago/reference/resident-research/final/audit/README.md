...
| voter / civic evidence | **294** | 21.3% | a poll book, tax list, muster roll, treaty payment or other public record |
...
| audit result | people | % |
| --- | ---: | ---: |
| `corroborated_across_categories` | 465 | 33.7% |
| `two_or_more_sources_one_category` | 17 | 1.2% |
| `one_source` | 323 | 23.4% |
| `the_letter_lists_alone` | 571 | 41.4% |
| `no_source` | 3 | 0.2% |
