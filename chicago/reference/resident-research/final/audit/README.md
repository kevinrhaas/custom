...
| file | what it is |
| --- | --- |
| `resident_audit_master.csv` | the table, one row per person, 2144 rows and 45 columns |
...
Each line is *how many of the 2144 people carry at least one record of that kind*.

| coverage | of 2144 | % | what counts |
| --- | ---: | ---: | --- |
| identities | **1282** | 59.8% | a name with at least one source id anywhere on the card |
| occupations | **219** | 10.2% | an occupation that is not `none_recorded` |
| household membership | **983** | 45.8% | recorded inside a household of two or more people |
| kinship | **663** | 30.9% | a stated kin relationship (brother, child, daughter, father, husband, mother, sister, son, wife) |
| property / address | **144** | 6.7% | the household resolves a `lives_at` or a `works_at` |
| voter / civic evidence | **302** | 14.1% | a poll book, tax list, muster roll, treaty payment or other public record |
| census linkage | **47** | 2.2% | an 1840 census row bridged to this person |
...
of the 2144 people. Before T-0733 nothing ruled on any of them, and a conflict
...
| --- | ---: | --- |
| no census linkage | 2097 | no 1840 census row is bridged to this person |
