...
| --- | ---: | ---: | --- |
| identities | **1285** | 99.8% | a name with at least one source id anywhere on the card |
| occupations | **133** | 10.3% | an occupation that is not `none_recorded` |
...
| audit result | people | % |
| --- | ---: | ---: |
| `corroborated_across_categories` | 458 | 35.6% |
...
| --- | ---: | --- |
| no census linkage | 1240 | no 1840 census row is bridged to this person |
| no address | 1212 | neither `lives_at` nor `works_at` resolves |
| unplaced | 1192 | the household carries division `unplaced`: in the town, on no lot |
