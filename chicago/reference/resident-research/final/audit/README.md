...
| file | what it is |
| --- | --- |
| `resident_audit_master.csv` | the table, one row per person, 1355 rows and 45 columns |
...
Each line is *how many of the 1355 people carry at least one record of that kind*.

| coverage | of 1355 | % | what counts |
| --- | ---: | ---: | --- |
| identities | **1352** | 99.8% | a name with at least one source id anywhere on the card |
| occupations | **133** | 9.8% | an occupation that is not `none_recorded` |
...
| voter / civic evidence | **288** | 21.3% | a poll book, tax list, muster roll, treaty payment or other public record |
...
| audit result | people | % |
| --- | ---: | ---: |
| `corroborated_across_categories` | 463 | 34.2% |
| `two_or_more_sources_one_category` | 15 | 1.1% |
| `one_source` | 325 | 24.0% |
| `the_letter_lists_alone` | 549 | 40.5% |
| `no_source` | 3 | 0.2% |
...
of the 1355 people. Before T-0733 nothing ruled on any of them, and a conflict
...
| rests on one source | 874 | one source id on the card and no second category to check it against |
| rests on the letter lists alone | 549 | known only from the post office's uncalled-for lists |
