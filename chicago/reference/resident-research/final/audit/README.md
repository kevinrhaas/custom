...
| file | what it is |
| --- | --- |
| `resident_audit_master.csv` | the table, one row per person, 1285 rows and 45 columns |
...
Each line is *how many of the 1285 people carry at least one record of that kind*.

| coverage | of 1285 | % | what counts |
| --- | ---: | ---: | --- |
| identities | **1279** | 99.5% | a name with at least one source id anywhere on the card |
| occupations | **127** | 9.9% | an occupation that is not `none_recorded` |
| household membership | **48** | 3.7% | recorded inside a household of two or more people |
| kinship | **15** | 1.2% | a stated kin relationship (brother, child, daughter, father, husband, mother, sister, son, wife) |
| property / address | **78** | 6.1% | the household resolves a `lives_at` or a `works_at` |
| voter / civic evidence | **302** | 23.5% | a poll book, tax list, muster roll, treaty payment or other public record |
...
| audit result | people | % |
| --- | ---: | ---: |
| `corroborated_across_categories` | 455 | 35.4% |
| `two_or_more_sources_one_category` | 13 | 1.0% |
| `one_source` | 247 | 19.2% |
| `the_letter_lists_alone` | 564 | 43.9% |
| `no_source` | 6 | 0.5% |
...
of the 1285 people. Before T-0733 nothing ruled on any of them, and a conflict
...
| --- | ---: | --- |
| no census linkage | 1238 | no 1840 census row is bridged to this person |
...
| no research row | 449 | no cohort ticket has reviewed this person; the programme reached 836 of 1285 |
