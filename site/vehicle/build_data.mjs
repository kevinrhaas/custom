...
const CITY = {
  ...
  'bloomington, mn': [44.840, -93.298], 'memphis, tn': [35.149, -90.049],
  'sioux falls, sd': [43.545, -96.731], 'new castle, de': [39.662, -75.586],
  'morrow, ga': [33.583, -84.339], 'raleigh, nc': [35.780, -78.639],
  'greenville, sc': [34.851, -82.399], 'henderson, nv': [36.040, -114.982],
  'wayne, nj': [40.925, -74.277], 'freehold, nj': [40.260, -74.274],
