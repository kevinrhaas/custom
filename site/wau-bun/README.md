...
One file per part — `js/data-text-part1.js` (472 KB), `-part2.js` (250 KB),
`-part3.js` (480 KB) — each **fetched only when the reader first opens that
...
All 158 scenes carry both, covering every chapter of the book end to end:
106,832 words of the 1856 text, a median of 545 words per scene.
